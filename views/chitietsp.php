...
.soluong {
    ...
    #tab_1 .product-item {
        width: 18%; /* Adjust the width of each product item for five columns */
        margin-right: 2%; /* Add a small right margin for spacing */
        margin-bottom: 20px;
    ...
    #tab_1 .product_image img {
        width: 100%; /* Make sure product images take full width */
        height: auto;
    }
